...
class Logger:
    ...
    def _init_logger(self):
        ...
        try:
            ...
            log_to_console = config.get("logging", "console", fallback=True)
            log_to_file = config.get("logging", "file_enabled", fallback=True)
            max_file_size = config.get("logging", "max_file_size", fallback=10485760)  # 10MB
